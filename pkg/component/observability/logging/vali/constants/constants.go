...
const (
	...
	// OtelCollectorTokenSecretName is the name of a secret in the kube-system namespace in the target cluster containing
	// opentelemetry-collector's token for communication with the kube-apiserver.
	OtelCollectorSecretName = "gardener-otelcollector"
)
