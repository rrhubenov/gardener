...
| DeployVictoriaLogs                       | `gardenlet`, `gardener-operator`   | Enables the deployment of `VictoriaLogs` instance in the control-plane of `Shoots`. VictoriaLogs will be used as the log aggregation system instead of Vali.                                                                                                                                                                                                                                                                                                                                                                                           |
